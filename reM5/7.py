...
if m.isdigit() and n.isdigit() and int(m) > 0 and int(n) > 0:
    ...
    print("Insira os números da primeira matriz (pressione Enter entre cada número): ")
    for i in range(m):
        linha = []
    ...
    print("Insira os números da segunda matriz (pressione Enter entre cada número): ")
    for i in range(m):
        linha = []
